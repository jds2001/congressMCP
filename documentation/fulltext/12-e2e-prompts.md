...
4. **Record a meta row:** prompt id, cell, model id, surface, thinking budget, context condition, build sha, document package/version/sha, timestamps, and **exit status**.
